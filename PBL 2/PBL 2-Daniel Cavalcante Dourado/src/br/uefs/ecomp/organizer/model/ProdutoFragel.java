 ...
 */
public class ProdutoFragel extends Produto{
    private int grauPrioridade;
    
    /**
     * Retorna o grau de prioridade de um item Fragil
    ...
    public ProdutoFragel(int grauPrioridade,String codigoIdentificador, int valorItem, int valorImposto, int custoFrete, String dataChegada, double peso) throws ParseException {
