...
public class Carro extends Motorizados{
    ...
    public Carro(String tipoCombustivel, String anoFabricacao, String marca, String modelo, String codigoIdentificador, int valorItem, int valorImposto, int custoFrete, String dataChegada, double peso) throws ParseException {
        super(anoFabricacao, marca, modelo, codigoIdentificador, valorItem, valorImposto, custoFrete, dataChegada, peso);
        this.tipoCombustivel = tipoCombustivel;
    }
    /**
     * Retorna tipo de combustivel
