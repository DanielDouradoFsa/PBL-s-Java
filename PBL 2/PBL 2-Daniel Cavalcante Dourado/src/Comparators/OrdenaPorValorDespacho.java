 ...
 */
public class OrdenaPorValorDespacho implements Comparator{
    /**
     * Compara o valor total entre dois objetos
     * @param t Objeto1
     * @param t1 Objeto2
    ...
    public int compare(Object t, Object t1) {
            Entrega x=(Entrega)t;
            Entrega y=(Entrega)t1;
            if(x.getValorMaximo()> y.getValorMaximo())
                return 1;
            else if(x.getValorMaximo()< y.getValorMaximo())
                return -1;
            return 0;
    }
