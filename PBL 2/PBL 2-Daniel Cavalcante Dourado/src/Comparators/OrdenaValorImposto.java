 ...
 */
public class OrdenaValorImposto implements Comparator
{
    /**
     * Compara o valor do imposto entre dois objetos
     * @param t Objeto1
     * @param t1 Objeto2
    ...
    public int compare(Object t, Object t1) {
        if(((Produto)t).getValorImposto()<((Produto)t1).getValorImposto())
            return -1;
        else if(((Produto)t).getValorImposto()>((Produto)t1).getValorImposto())
            return 1;
        return 0;
    }
}
