 ...
 */
public class OrdenaPorValor implements Comparator{
    /**
     * Compara o valor entre dois objetos
     * @param t Objeto1
     * @param t1 Objeto2
    ...
    public int compare(Object t, Object t1) {
         if(((Produto)t).getValorItem()<((Produto)t1).getValorItem())
            return -1;
        else if(((Produto)t).getValorItem()>((Produto)t1).getValorItem())
            return 1;
        return 0;
    }
}
